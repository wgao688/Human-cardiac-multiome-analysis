...
We will only perform analysis for cell types in which there are at least 2000 cells for all age+disease statuses (fetal, ND, disease). These are the following cell types that satisfy those conditions: Cardiomyocyte, Endothelial, Fibroblast, Myeloid, Pericyte
```
...
- 04C_produce_fetal_GRN_plot.ipynb
```

### STEP 5: Examine fetal reactivation

Perform fetal reactivation analysis to identify TFs that are both up or both down in disease and fetal states
```
- 05_fetal_reactivation_TFs.ipynb
```
