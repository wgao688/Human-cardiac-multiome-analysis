...
results_dir = "age_results_dir/"
plots_dir = "age_plots_dir/"
...
for cell_type in cell_types:
    ...
    if len(valid_studies) > 0:
        ...
        pseudobulk_res = pd.read_csv("../pydeseq2_results/" + cell_type + "_age_group_old_vs_young_results.csv", index_col = 0)
        ...
        for study in valid_studies:
            up_genes, down_genes = funcs.get_single_study_genes(all_study_df=all_age_results, study_name=study)
