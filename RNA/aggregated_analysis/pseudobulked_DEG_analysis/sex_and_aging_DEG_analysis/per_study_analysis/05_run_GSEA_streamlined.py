...
#contrast_names = ["age", "sex", "disease", "fetal"]
contrast_names = ["age", "sex"]
#corresponding_contrast_file_names = ["age-group_old_vs_young", "sex_male_vs_female", "disease-binary_Y_vs_N", "age-group_fetal_vs_young"]
corresponding_contrast_file_names = ["age_group_old_vs_young", "sex_male_vs_female"]
