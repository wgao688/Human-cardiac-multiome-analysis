...
for cell_type in cell_types:
    ...
    filt_metadata = metadata.loc[(metadata.age_status == "postnatal"), ].copy()
    ...
    # run deseq2 using only the valid contrasts
    ...
    try:
        ...
        print(f"Could not perform DESeq2 analysis for {cell_type} due to singular matrix")
